...
/**
 * Gap/CFS Feature Page: No co-parenting app or family communication tools.
 * Slug: no-co-parenting-app-or-family-communication-tools
 * Backend: /api/gap-no-co-parenting-app-or-family-communication-tools
 */
export default function NoCoParentingAppOrFamilyCommunicationToolsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-co-parenting-app-or-family-communication-tools', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No co-parenting app or family communication tools.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No co-parenting app or family communication tools.</p>
