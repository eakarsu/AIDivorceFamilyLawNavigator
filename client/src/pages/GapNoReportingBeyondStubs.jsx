...
/**
 * Gap/CFS Feature Page: No reporting beyond stubs.
 * Slug: no-reporting-beyond-stubs
 * Backend: /api/gap-no-reporting-beyond-stubs
 */
export default function NoReportingBeyondStubsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-reporting-beyond-stubs', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No reporting beyond stubs.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No reporting beyond stubs.</p>
