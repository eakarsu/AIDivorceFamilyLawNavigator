...
/**
 * Gap/CFS Feature Page: Financial asset valuation
 * Slug: financial-asset-valuation
 * Backend: /api/cf-financial-asset-valuation
 */
export default function FinancialAssetValuationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-financial-asset-valuation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Financial asset valuation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Use market data and comparables to suggest fair valuations for contested assets.</p>
