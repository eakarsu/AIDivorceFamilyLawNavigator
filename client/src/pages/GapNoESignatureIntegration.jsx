...
/**
 * Gap/CFS Feature Page: No e-signature integration.
 * Slug: no-e-signature-integration
 * Backend: /api/gap-no-e-signature-integration
 */
export default function NoESignatureIntegrationPage() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No e-signature integration.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No e-signature integration.</p>
