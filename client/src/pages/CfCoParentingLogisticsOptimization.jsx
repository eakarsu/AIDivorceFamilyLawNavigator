...
/**
 * Gap/CFS Feature Page: Co-parenting logistics optimization
 * Slug: co-parenting-logistics-optimization
 * Backend: /api/cf-co-parenting-logistics-optimization
 */
export default function CoParentingLogisticsOptimizationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-co-parenting-logistics-optimization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Co-parenting logistics optimization</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Optimize custody schedules considering work, school, extracurricular constraints.</p>
