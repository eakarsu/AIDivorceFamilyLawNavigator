...
/**
 * Gap/CFS Feature Page: State-aware legal guidance
 * Slug: state-aware-legal-guidance
 * Backend: /api/cf-state-aware-legal-guidance
 */
export default function StateAwareLegalGuidancePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-state-aware-legal-guidance', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>State-aware legal guidance</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Tailor advice/calculations to specific state laws; highlight state-specific implications.</p>
