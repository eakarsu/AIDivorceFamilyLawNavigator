...
/**
 * Gap/CFS Feature Page: Custody outcome prediction
 * Slug: custody-outcome-prediction
 * Backend: /api/cf-custody-outcome-prediction
 */
export default function CustodyOutcomePredictionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-custody-outcome-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Custody outcome prediction</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>ML model predicts likely custody outcome based on case facts; prepare accordingly.</p>
