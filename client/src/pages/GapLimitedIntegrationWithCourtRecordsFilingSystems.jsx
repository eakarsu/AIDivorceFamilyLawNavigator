...
/**
 * Gap/CFS Feature Page: Limited integration with court records / filing systems.
 * Slug: limited-integration-with-court-records-filing-systems
 * Backend: /api/gap-limited-integration-with-court-records-filing-systems
 */
export default function LimitedIntegrationWithCourtRecordsFilingSystemsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-integration-with-court-records-filing-systems', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited integration with court records / filing systems.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited integration with court records / filing systems.</p>
