...
/**
 * Gap/CFS Feature Page: Limited legal-research integration (LexisNexis, Westlaw).
 * Slug: limited-legal-research-integration-lexisnexis-westlaw
 * Backend: /api/gap-limited-legal-research-integration-lexisnexis-westlaw
 */
export default function LimitedLegalResearchIntegrationLexisnexisWestlawPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-legal-research-integration-lexisnexis-westlaw', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited legal-research integration (LexisNexis, Westlaw).</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited legal-research integration (LexisNexis, Westlaw).</p>
